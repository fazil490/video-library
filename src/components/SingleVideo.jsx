  ...
  return (
    <div className="p-4 md:p-10 lg:ml-[13.6rem] xl:mx-[13.6rem]">
      ...
      <div className="py-4">
        ...
        <p className="text-md md:text-xl text-zinc-200 ">{video?.creator}</p>
        <div className="flex gap-4 my-4">
          <span
            ...
            className={`${
              like.find((item) => item._id === video._id) ? "bg-redbg" : ""
            } flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-800 cursor-pointer`}
          >
            <BiLike />
        ...
        <hr className="border-none my-4 p-[0.1px] bg-zinc-700" />
